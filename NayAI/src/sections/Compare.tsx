...
const Compare = () => {
  return (
    <section
        id="about" className="bg-neutral-200 text-neutral-900 py-24"
    >
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                Most image processing tools jump straight to the result. You see the original image and the classic "Yes, this is AI image" text, but the reasoning of "why?" itself remains invisible from behind.
                </p>
